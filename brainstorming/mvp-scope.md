...
MVP hiện code theo hướng "backend gửi email" (xem bước 4) vì đó là cách nhanh nhất để chạy thử vòng lặp cá nhân hoá + AI content. Nhưng **kênh chính về lâu dài là bản in A4 gửi bưu điện, không phải email** (xem `product-vision.md` mục "Kênh gửi nội dung") — vì trẻ ít dùng điện thoại/internet. Quy trình in-and-mail cụ thể chưa chốt, sẽ thiết kế sau. Khi làm onboarding, cân nhắc việc rồi cũng cần thu thập địa chỉ nhà, không chỉ email.
...
- Quy trình in ấn + gửi bưu điện (kênh chính dài hạn) — MVP tạm dùng email để chạy thử vòng lặp nội dung trước
