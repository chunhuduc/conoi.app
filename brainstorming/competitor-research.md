...
## Phác thảo cấu trúc landing page ConOi (ban đầu, đã bị thay thế — xem "Cấu trúc landing page đã chốt" bên dưới)
...
## Cấu trúc landing page đã chốt 📌

Landing page thật (`src/app/page.tsx`) **CHỈ gồm 1 màn hình Hero**, không làm thêm các section 2-6 đã phác thảo ở trên:

- Headline cảm xúc ("Con ơi, hôm nay ba có chuyện muốn kể")
- 1 câu giải thích duy nhất (cá nhân hoá thật, đúng giọng văn cha/mẹ)
- Lá thư mẫu (`LetterStack`) làm trung tâm thị giác, lật/vuốt được — đóng luôn vai trò "aha moment" thay vì cần 1 hành trình cá nhân hoá riêng như bản phác thảo ban đầu
- 1 CTA duy nhất ("Bắt đầu gửi cho con") + dòng phụ (miễn phí cho 1 con · thiết lập 2 phút)

Lý do thay đổi: đơn giản hơn phác thảo ban đầu, để lá thư mẫu tự nói lên giá trị sản phẩm thay vì giải thích qua nhiều section. Các phần "giải thích tại sao khác", "trust dữ liệu trẻ em", "social proof" không bị bỏ hẳn — có thể cần khi có traffic thật/feedback cho thấy landing 1 màn hình chưa đủ thuyết phục, nhưng không phải việc cần làm cho MVP hiện tại.
